...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='modelzoo/coco2017-0.241078ap-model.pth', help='The path of the .pth model to be transformed')
    parser.add_argument('--vid', type=str, default=vid_path,  help='The path of test image')
    ...
    out = cv2.VideoWriter('chikenresult.mp4', cv2.VideoWriter_fourcc('m', 'p', '4', 'v'), 40, (frame_width, frame_height))  # 保存视频,mp4文件必须运行时不退出，否则无法播放
    while ret==True:
